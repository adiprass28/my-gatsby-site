...
1. Visit to https://www.gatsbyjs.com/docs/programmatically-create-pages-from-data/ link
2. Create "gatsby-node.js" file in main directory.
3. In terminal, run:
```bash
gatsby develop
```
4. Open  http://localhost:8000/___graphql link
5. In GraphiQl console, run:
```js
query MyQuery {
